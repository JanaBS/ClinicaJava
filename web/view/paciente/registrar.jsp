<%-- 
    Document   : registrar
    Created on : 18/11/2022, 15:29:16
...
<body>
    ...
    <div class="container-sm">
        <div class="container position-absolute top-50 start-50 translate-middle p-4 rounded">
            ...
            <form action="PacienteController?btEnviar=IncluirPaciente" method="POST">
                ...
                <div class="row">
                    <div class="col-auto">
                        <button type="submit" class="btn btn-light text-danger mt-3">Registrar</button>
                      </div>
                </div>
            </form>
        </div>
