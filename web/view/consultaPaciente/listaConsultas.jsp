<%-- 
    ...
    Created on : 19/11/2022, 14:41:05
...
<html>
    ...
    <body>
        ...
        <div class="container mt-4">
            ...
            <a href="PacienteController?acao=Cadastrar" class="mb-2 btn btn-light text-danger" METHOD="GET">Nova Consulta</a>
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        %>
                    <td><a href="PacienteController?acao=Alterar&id=<%=consulta.getId()%>" class="btn btn-warning">Alterar</a></td>
                    <td><form action="PacienteController?btEnviar=ExcluirConsulta&id=<%=consulta.getId()%>" method="POST"><button class="btn btn-danger" type="submit">Excluir</button></form></td>
                        <%   out.println("</tr>");
                            }
                        %>
                    </tbody>
