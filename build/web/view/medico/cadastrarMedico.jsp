<%-- 
    ...
    Created on : 09/12/2022, 22:00:14
...
<body>
        ...
        <div class="container position-absolute top-50 start-50 translate-middle  p-4 rounded">
            <div class="row justify-content-start">
                <div class="col-12">
                    <div class="h5 text-left text-dark mb-3">Cadastrar médico</div>
                </div>
            </div>
            <form action="AdministradorController?btEnviar=CadastrarMedico" method="POST">
                <div class="row">
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-2">
                            ...
                            <div class="">
                                <input type="CRM" class="form-control col-sm-12" id="ControlInput2" name="crm">
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <label for="ControlInput3" class="form-label">UF CRM</label>
                            <div class="">
                                <input type="UF-CRM" class="form-control col-sm-12" id="ControlInput3" name="estadocrm">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <label for="ControlInput4" class="form-label">CPF</label>
                            <div class="">
                                <input type="CPF" class="form-control col-sm-12" id="ControlInput4" name="cpf">
                            </div>
                        </div>
                </div>
                <div class="row">   
