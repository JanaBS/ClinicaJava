<%-- 
    ...
    Created on : 11/12/2022, 09:42:08
    ...
    <body>
        ...
        <div class="container-sm">
            <div class="container position-absolute top-50 start-50 translate-middle p-4 rounded">
                <form action="AdministradorController?btEnviar=CadastrarPlano" method="POST">
                    <div class="row justify-content-start">
                        <div class="col-12">
                            <div class="h5 text-left text-dark mb-3">Cadastrar tipo de plano de saúde</div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
