<%-- 
    ...
    Created on : 08/12/2022, 20:41:35
    ...
    <div class="container-sm">
        <div class="container position-absolute top-50 start-50 translate-middle p-4 rounded">
            <div class="row justify-content-start">
                <div class="col-12">
                    <div class="h5 text-left text-dark mb-3">Alterar paciente</div>
                </div>
            </div>
            <%
            ...
            %>
            <form action="AdministradorController?btEnviar=AlterarPaciente" method="POST">
                <input type="hidden" name="id" value="<%=paciente.getId()%>" class="form-control">
                <div class="row">
                        <div class="col-sm-6">
                            <label for="Nome" class="form-label">Nome</label>
                            <input type="text" class="form-control col-sm-12" id="Nome" name="nome" value="<%=paciente.getNome()%>">
                        </div>
                        <div class="col-sm-6">
                            <label for="cpf" class="form-label">CPF</label>
                            <input type="text" class="form-control col-sm-12" id="cpf" name="cpf" value="<%=paciente.getCpf()%>">
                        </div>
                </div>
                <div class="row">   
                    ...
                    <div class="col-sm-6">
                        <label for="senha" class="col-sm-2 col-form-label mt-1" value="<%=paciente.getAutorizado()%>">Autorizado</label>
                        <div>
                ...
                <div class="row">
                    <div class="col-auto">
                        <button type="submit" class="btn btn-light mt-3 text-danger">Alterar</button>
                      </div>
                </div>
            </form>
        </div>
